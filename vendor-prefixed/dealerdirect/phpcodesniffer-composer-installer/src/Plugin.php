 ...
 * @license MIT
 */
namespace Dekode\GravityForms\Vendor\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use Dekode\GravityForms\Vendor\Composer\Composer;
use Dekode\GravityForms\Vendor\Composer\EventDispatcher\EventSubscriberInterface;
use Dekode\GravityForms\Vendor\Composer\IO\IOInterface;
use Dekode\GravityForms\Vendor\Composer\Package\AliasPackage;
use Dekode\GravityForms\Vendor\Composer\Package\PackageInterface;
use Dekode\GravityForms\Vendor\Composer\Package\RootPackageInterface;
use Dekode\GravityForms\Vendor\Composer\Plugin\PluginInterface;
use Dekode\GravityForms\Vendor\Composer\Script\Event;
use Dekode\GravityForms\Vendor\Composer\Script\ScriptEvents;
use Dekode\GravityForms\Vendor\Composer\Util\Filesystem;
use Dekode\GravityForms\Vendor\Composer\Util\ProcessExecutor;
use Dekode\GravityForms\Vendor\Symfony\Component\Finder\Finder;
use Dekode\GravityForms\Vendor\Symfony\Component\Process\Exception\LogicException;
use Dekode\GravityForms\Vendor\Symfony\Component\Process\Exception\ProcessFailedException;
use Dekode\GravityForms\Vendor\Symfony\Component\Process\Exception\RuntimeException;
use Dekode\GravityForms\Vendor\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \Dekode\GravityForms\Vendor\Composer\Plugin\PluginInterface, \Dekode\GravityForms\Vendor\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\Dekode\GravityForms\Vendor\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\Dekode\GravityForms\Vendor\Composer\Composer $composer, \Dekode\GravityForms\Vendor\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\Dekode\GravityForms\Vendor\Composer\Composer $composer, \Dekode\GravityForms\Vendor\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\Dekode\GravityForms\Vendor\Composer\Composer $composer, \Dekode\GravityForms\Vendor\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \Dekode\GravityForms\Vendor\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \Dekode\GravityForms\Vendor\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\Dekode\GravityForms\Vendor\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \Dekode\GravityForms\Vendor\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \Dekode\GravityForms\Vendor\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \Dekode\GravityForms\Vendor\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \Dekode\GravityForms\Vendor\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \Dekode\GravityForms\Vendor\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \Dekode\GravityForms\Vendor\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \Dekode\GravityForms\Vendor\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\Dekode\GravityForms\Vendor\Composer\Package\PackageInterface $package) {
            if ($package instanceof \Dekode\GravityForms\Vendor\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \Dekode\GravityForms\Vendor\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \Dekode\GravityForms\Vendor\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
