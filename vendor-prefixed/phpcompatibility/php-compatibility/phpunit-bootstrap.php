...
if (\class_exists('Dekode\\GravityForms\\Vendor\\PHPUnit\\Runner\\Version') && \version_compare(\Dekode\GravityForms\Vendor\PHPUnit\Runner\Version::id(), '6.0', '>=') && \class_exists('Dekode\\GravityForms\\Vendor\\PHPUnit_Framework_TestCase') === \false) {
    \class_alias('Dekode\\GravityForms\\Vendor\\PHPUnit\\Framework\\TestCase', 'Dekode\\GravityForms\\Vendor\\PHPUnit_Framework_TestCase');
}
