 ...
 */
class NewArrayStringDereferencingSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    {
        return array(\T_ARRAY, \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY, \T_CONSTANT_ENCAPSED_STRING);
    }
    /**
     ...
     */
    public function isArrayStringDereferencing(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
