 ...
 */
class NewDynamicAccessToStaticSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$prevNonEmpty]['code'] === \Dekode\GravityForms\Vendor\T_SELF || $tokens[$prevNonEmpty]['code'] === \Dekode\GravityForms\Vendor\T_PARENT || $tokens[$prevNonEmpty]['code'] === \T_STATIC) {
            return;
        }
