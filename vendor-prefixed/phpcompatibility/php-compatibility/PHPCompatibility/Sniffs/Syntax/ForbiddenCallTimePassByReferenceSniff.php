 ...
 */
class ForbiddenCallTimePassByReferenceSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $findTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens;
        $findTokens[] = \Dekode\GravityForms\Vendor\T_BITWISE_AND;
        ...
        $openBracket = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $stackPtr + 1, null, \true);
        if ($openBracket === \false || $tokens[$openBracket]['code'] !== \Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS || isset($tokens[$openBracket]['parenthesis_closer']) === \false) {
            return;
        }
     ...
     * @return bool
     */
    protected function isCallTimePassByReferenceParam(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $parameter, $nestingLevel)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        do {
            $nextVariable = $phpcsFile->findNext(array(\T_VARIABLE, \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY, \Dekode\GravityForms\Vendor\T_CLOSURE), $nextVariable + 1, $searchEndToken);
            ...
            $tokenBefore = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $nextVariable - 1, $searchStartToken, \true);
            if ($tokenBefore === \false || $tokens[$tokenBefore]['code'] !== \Dekode\GravityForms\Vendor\T_BITWISE_AND) {
            ...
            // Checking this: $value = my_function(...[*]&$arg...).
            $tokenBefore = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $tokenBefore - 1, $searchStartToken, \true);
