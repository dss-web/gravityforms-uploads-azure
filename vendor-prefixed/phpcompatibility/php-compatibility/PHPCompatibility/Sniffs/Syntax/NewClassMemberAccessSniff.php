 ...
 */
class NewClassMemberAccessSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($pointers as $open => $close) {
            ...
            if ($tokens[$stackPtr]['code'] === \T_NEW && $tokens[$open]['code'] !== \Dekode\GravityForms\Vendor\T_OPEN_CURLY_BRACKET) {
                if ($supports53 === \true) {
     ...
     */
    public function isClassMemberAccess(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        $prevBeforeParenthesis = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $parenthesisOpener - 1, null, \true);
        ...
        do {
            $nextNonEmpty = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $end + 1, null, \true, null, \true);
            ...
            if ($tokens[$nextNonEmpty]['code'] === \Dekode\GravityForms\Vendor\T_OPEN_SQUARE_BRACKET || $tokens[$nextNonEmpty]['code'] === \Dekode\GravityForms\Vendor\T_OPEN_CURLY_BRACKET) {
