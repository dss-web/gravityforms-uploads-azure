 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\Extensions;
 ...
 */
class RemovedExtensionsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractRemovedFeatureSniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$openBracket]['code'] !== \Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS) {
            // Not a function call.
            return;
        }
        ...
        $search = \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens;
        $search[] = \Dekode\GravityForms\Vendor\T_BITWISE_AND;
