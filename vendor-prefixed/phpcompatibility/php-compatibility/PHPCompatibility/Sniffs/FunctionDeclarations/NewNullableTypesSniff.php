 ...
 * @since 7.0.7
 */
class NewNullableTypesSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    {
        $tokens = array(\T_FUNCTION, \Dekode\GravityForms\Vendor\T_CLOSURE);
        if (\defined('Dekode\\GravityForms\\Vendor\\T_RETURN_TYPE')) {
            $tokens[] = \Dekode\GravityForms\Vendor\T_RETURN_TYPE;
        }
        return $tokens;
    }
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokenCode === \T_FUNCTION || $tokenCode === \Dekode\GravityForms\Vendor\T_CLOSURE) {
     ...
     * @return void
     */
    protected function processFunctionDeclaration(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
     ...
     * @return void
     */
    protected function processReturnType(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        if (isset($tokens[$stackPtr - 1]['code']) === \false) {
            return;
        }
        $previous = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        // Deal with namespaced class names.
        if ($tokens[$previous]['code'] === \T_NS_SEPARATOR) {
            $validTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens;
        ...
        if (\defined('Dekode\\GravityForms\\Vendor\\T_NULLABLE') === \true && $tokens[$previous]['type'] === 'T_NULLABLE' || \defined('Dekode\\GravityForms\\Vendor\\T_NULLABLE') === \false && $tokens[$previous]['code'] === \Dekode\GravityForms\Vendor\T_INLINE_THEN) {
