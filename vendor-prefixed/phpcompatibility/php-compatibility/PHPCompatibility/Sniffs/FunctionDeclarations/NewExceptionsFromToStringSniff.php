 ...
 * @since 9.2.0
 */
class NewExceptionsFromToStringSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function register()
    {
        ...
        $this->docblockIgnoreTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$methodPrefixes;
        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$phpcsCommentTokens)) {
            $this->docblockIgnoreTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$phpcsCommentTokens;
        }
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($commentEnd === \false || $tokens[$commentEnd]['code'] !== \Dekode\GravityForms\Vendor\T_DOC_COMMENT_CLOSE_TAG) {
            return;
        }
