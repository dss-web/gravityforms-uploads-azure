 ...
 */
class NewParamTypeDeclarationsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
     * A list of new types.
     *
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $paramNames = \Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::getMethodParameters($phpcsFile, $stackPtr);
        if (empty($paramNames)) {
            return;
        }
