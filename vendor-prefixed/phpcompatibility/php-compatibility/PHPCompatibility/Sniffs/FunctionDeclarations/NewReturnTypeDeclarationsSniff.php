 ...
 */
class NewReturnTypeDeclarationsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
     * A list of new types
     *
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        } elseif ($tokens[$stackPtr]['code'] === \T_STRING || \defined('Dekode\\GravityForms\\Vendor\\T_RETURN_TYPE') && $tokens[$stackPtr]['code'] === \Dekode\GravityForms\Vendor\T_RETURN_TYPE) {
