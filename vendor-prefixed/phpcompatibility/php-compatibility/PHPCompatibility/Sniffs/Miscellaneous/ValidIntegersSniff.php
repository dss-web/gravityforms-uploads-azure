 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\Miscellaneous;
 ...
 */
class ValidIntegersSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
     ...
     * @return string
     */
    private function getBinaryInteger(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $tokens, $stackPtr)
    {
        $length = 2;
