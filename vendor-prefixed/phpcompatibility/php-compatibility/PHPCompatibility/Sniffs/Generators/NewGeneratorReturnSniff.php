 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\Generators;
 ...
 * @since 8.2.0
 */
class NewGeneratorReturnSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
     ...
     * @var array
     */
    private $validConditions = array(\T_FUNCTION => \T_FUNCTION, \Dekode\GravityForms\Vendor\T_CLOSURE => \Dekode\GravityForms\Vendor\T_CLOSURE);
    /**
    ...
    public function register()
    {
         ...
         */
        if (\version_compare(\PHP_VERSION_ID, '50500', '<') === \true && \version_compare(\Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::getVersion(), '3.1.0', '<') === \true) {
            $targets[] = \T_STRING;
        }
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $targets = array(\T_RETURN, \Dekode\GravityForms\Vendor\T_CLOSURE, \T_FUNCTION, \T_CLASS);
