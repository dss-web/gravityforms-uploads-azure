 ...
 */
class NewConstantArraysUsingDefineSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $array = $phpcsFile->findNext(array(\T_ARRAY, \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY), $secondParam['start'], $secondParam['end'] + 1);
        if ($array !== \false) {
