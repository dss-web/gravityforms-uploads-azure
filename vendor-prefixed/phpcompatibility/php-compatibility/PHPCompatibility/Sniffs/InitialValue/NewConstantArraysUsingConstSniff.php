 ...
 */
class NewConstantArraysUsingConstSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $find = array(\T_ARRAY => \T_ARRAY, \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY => \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY);
        while (($hasArray = $phpcsFile->findNext($find, $stackPtr + 1, null, \false, null, \true)) !== \false) {
            ...
            $stackPtr = $hasArray;
            if ($tokens[$hasArray]['code'] === \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY && isset($tokens[$hasArray]['bracket_closer'])) {
