 ...
 * @since 7.0.7
 */
class NewConstVisibilitySniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($prevToken === \false || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$scopeModifiers[$tokens[$prevToken]['code']]) === \false) {
            return;
        }
