 ...
 * @since 7.0.0
 */
class NewAnonymousClassesSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function register()
    {
        if (\defined('Dekode\\GravityForms\\Vendor\\T_ANON_CLASS')) {
            $this->indicators[\Dekode\GravityForms\Vendor\T_ANON_CLASS] = \Dekode\GravityForms\Vendor\T_ANON_CLASS;
        }
        return array(\T_NEW);
    }
    /**
