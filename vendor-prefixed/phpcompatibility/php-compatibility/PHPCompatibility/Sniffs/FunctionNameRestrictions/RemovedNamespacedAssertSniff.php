 ...
 * @since 9.0.0
 */
class RemovedNamespacedAssertSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
     ...
     * @var array
     */
    private $scopes = array(\T_CLASS, \T_INTERFACE, \T_TRAIT, \Dekode\GravityForms\Vendor\T_CLOSURE);
    /**
    ...
    public function register()
    {
        ...
        if (\defined('Dekode\\GravityForms\\Vendor\\T_ANON_CLASS')) {
            $this->scopes[] = \Dekode\GravityForms\Vendor\T_ANON_CLASS;
        }
