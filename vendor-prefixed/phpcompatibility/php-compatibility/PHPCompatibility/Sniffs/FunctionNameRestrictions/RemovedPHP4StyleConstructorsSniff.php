 ...
 */
class RemovedPHP4StyleConstructorsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $oldConstructorPos = -1;
        while (($nextFunc = $phpcsFile->findNext(array(\T_FUNCTION, \Dekode\GravityForms\Vendor\T_DOC_COMMENT_OPEN_TAG), $nextFunc + 1, $scopeCloser)) !== \false) {
            // Skip over docblocks.
            if ($tokens[$nextFunc]['code'] === \Dekode\GravityForms\Vendor\T_DOC_COMMENT_OPEN_TAG) {
