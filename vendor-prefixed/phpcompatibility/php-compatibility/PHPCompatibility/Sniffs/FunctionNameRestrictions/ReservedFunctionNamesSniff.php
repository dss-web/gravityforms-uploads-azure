 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\FunctionNameRestrictions;

use Dekode\GravityForms\Vendor\Generic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff as PHPCS_CamelCapsFunctionNameSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer_File as File;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer_Standards_AbstractScopeSniff as PHPCS_AbstractScopeSniff;
 ...
 */
class ReservedFunctionNamesSniff extends \Dekode\GravityForms\Vendor\Generic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff
{
    /**
    ...
    public function __construct()
    {
        ...
        if (\defined('Dekode\\GravityForms\\Vendor\\T_ANON_CLASS')) {
            $scopeTokens[] = \Dekode\GravityForms\Vendor\T_ANON_CLASS;
        }
        // Call the grand-parent constructor directly.
        \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Standards_AbstractScopeSniff::__construct($scopeTokens, array(\T_FUNCTION), \true);
     ...
     * @return void
     */
    protected function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (\preg_match('|^__[^_]|', $methodName) > 0) {
            ...
            if (isset($this->magicMethods[$magicPart]) === \false && isset($this->methodsDoubleUnderscore[$magicPart]) === \false) {
                ...
                $scopeNextNonEmpty = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $currScope + 1, null, \true);
     ...
     * @return void
     */
    protected function processTokenOutsideScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        if ($this->isFunctionDeprecated($phpcsFile, $stackPtr) === \true) {
            /*
             * Deprecated functions don't have to comply with the naming conventions,
     ...
     * @return bool
     */
    private function isFunctionDeprecated(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        $find = \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$methodPrefixes;
        $find[] = \T_WHITESPACE;
        $commentEnd = $phpcsFile->findPrevious($find, $stackPtr - 1, null, \true);
        if ($tokens[$commentEnd]['code'] !== \Dekode\GravityForms\Vendor\T_DOC_COMMENT_CLOSE_TAG) {
