 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\Interfaces;
 ...
 */
class NewInterfacesSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
    ...
    public function register()
    {
        ...
        $targets = array(\T_CLASS, \T_FUNCTION, \Dekode\GravityForms\Vendor\T_CLOSURE);
     ...
     * @return void
     */
    private function processClassToken(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $interfaces = \Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::findImplementedInterfaceNames($phpcsFile, $stackPtr);
