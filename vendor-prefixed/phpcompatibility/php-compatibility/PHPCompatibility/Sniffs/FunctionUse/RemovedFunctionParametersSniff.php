 ...
 */
class RemovedFunctionParametersSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractRemovedFeatureSniff
{
    /**
     ...
     */
    protected function curlVersionInvalidValue(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, array $parameter)
    {
        $tokens = $phpcsFile->getTokens();
        $raw = '';
