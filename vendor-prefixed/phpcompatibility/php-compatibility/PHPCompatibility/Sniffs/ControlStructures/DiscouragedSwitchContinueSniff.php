 ...
 * @since 8.2.0
 */
class DiscouragedSwitchContinueSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
     ...
     * @var array
     */
    protected $acceptedLevelTokens = array(\T_LNUMBER => \T_LNUMBER, \Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS => \Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS, \Dekode\GravityForms\Vendor\T_CLOSE_PARENTHESIS => \Dekode\GravityForms\Vendor\T_CLOSE_PARENTHESIS);
    /**
    ...
    {
        $this->acceptedLevelTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$arithmeticTokens;
        $this->acceptedLevelTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens;
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        do {
            ...
            do {
                ...
                $nextSemicolon = $phpcsFile->findNext(array(\Dekode\GravityForms\Vendor\T_SEMICOLON, \T_CLOSE_TAG), $continue + 1, $caseCloser);
                $codeString = '';
