 ...
 * @since 9.0.0
 */
class NewListInForeachSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $hasList = $phpcsFile->findNext(array(\T_LIST, \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY), $asToken + 1, $closer);
        if ($hasList === \false) {
            return;
        }
