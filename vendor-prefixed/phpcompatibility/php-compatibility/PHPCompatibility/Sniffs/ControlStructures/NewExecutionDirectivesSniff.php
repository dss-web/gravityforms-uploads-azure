 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\ControlStructures;
 ...
 */
class NewExecutionDirectivesSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
    ...
    public function register()
    {
        ...
        $this->ignoreTokens[\Dekode\GravityForms\Vendor\T_EQUAL] = \Dekode\GravityForms\Vendor\T_EQUAL;
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($tokens[$stackPtr]['parenthesis_opener'], $tokens[$stackPtr]['parenthesis_closer']) === \true) {
            ...
            if (\version_compare(\Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::getVersion(), '2.3.4', '>=')) {
                return;
            }
            // Deal with PHPCS 2.3.0-2.3.3 which do not yet set the parenthesis properly for declare statements.
            $openParenthesis = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS, $stackPtr + 1, null, \false, null, \true);
     ...
     * @return void
     */
    public function addError(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, array $itemInfo, array $errorInfo)
    {
     ...
     * @return void
     */
    protected function addWarningOnInvalidValue(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $directive)
    {
        $tokens = $phpcsFile->getTokens();
        $value = $tokens[$stackPtr]['content'];
        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$stringTokens[$tokens[$stackPtr]['code']]) === \true) {
