 ...
 * @since 9.0.0
 */
class NewForeachExpressionReferencingSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
         ...
         */
        $hasReference = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\T_BITWISE_AND, $asToken + 1, $closer);
