 ...
 * @since 7.0.7
 */
class NewMultiCatchSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $hasBitwiseOr = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\T_BITWISE_OR, $token['parenthesis_opener'], $token['parenthesis_closer']);
