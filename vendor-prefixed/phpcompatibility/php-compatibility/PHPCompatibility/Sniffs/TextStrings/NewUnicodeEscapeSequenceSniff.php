 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\TextStrings;
 ...
 * @since 9.3.0
 */
class NewUnicodeEscapeSequenceSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    {
        return array(\T_CONSTANT_ENCAPSED_STRING, \Dekode\GravityForms\Vendor\T_DOUBLE_QUOTED_STRING, \Dekode\GravityForms\Vendor\T_HEREDOC);
    }
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \T_CONSTANT_ENCAPSED_STRING) {
            ...
            } catch (\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Exception $e) {
