 ...
 * @since 7.1.4
 */
class NewUseConstFunctionSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $functionOrConstName = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $nextNonEmpty + 1, null, \true);
        if ($functionOrConstName === \false || ($tokens[$functionOrConstName]['content'] === 'as' || $tokens[$functionOrConstName]['code'] === \Dekode\GravityForms\Vendor\T_COMMA)) {
