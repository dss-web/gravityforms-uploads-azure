 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\Upgrade;
 ...
 * @since 8.2.0
 */
class LowPHPCSSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
         ...
         */
        $reportWidth = \Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::getCommandLineData($phpcsFile, 'reportWidth');
        if (empty($reportWidth)) {
            $reportWidth = 80;
        }
        $showSources = \Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::getCommandLineData($phpcsFile, 'showSources');
        if ($showSources === \true) {
            $reportWidth += 6;
        }
