 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\Keywords;
 ...
 * @since 5.5
 */
class ForbiddenNamesSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    {
        $this->allowedModifiers = \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$scopeModifiers;
        $this->allowedModifiers[\T_FINAL] = \T_FINAL;
        $tokens = $this->targetedTokens;
        if (\defined('Dekode\\GravityForms\\Vendor\\T_ANON_CLASS')) {
            $tokens[] = \Dekode\GravityForms\Vendor\T_ANON_CLASS;
        }
        return $tokens;
    }
    /**
     ...
     * @return void
     */
    public function processNonString(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $tokens)
    {
        ...
        if ($tokens[$stackPtr]['type'] === 'T_ANON_CLASS' || $tokens[$stackPtr]['type'] === 'T_CLASS') {
            ...
            $maybeUseNext = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $nextNonEmpty + 1, null, \true, null, \true);
            ...
            $endToken = $phpcsFile->findNext(array(\Dekode\GravityForms\Vendor\T_SEMICOLON, \Dekode\GravityForms\Vendor\T_OPEN_CURLY_BRACKET), $stackPtr + 1, null, \false, null, \true);
     ...
     * @return void
     */
    public function processString(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $tokens)
    {
     ...
     * @return void
     */
    protected function addError(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $content, $data)
    {
    ...
    {
        return \in_array($token['code'], array(\Dekode\GravityForms\Vendor\T_CLOSE_CURLY_BRACKET, \Dekode\GravityForms\Vendor\T_SEMICOLON, \Dekode\GravityForms\Vendor\T_COMMA), \true);
    }
}
