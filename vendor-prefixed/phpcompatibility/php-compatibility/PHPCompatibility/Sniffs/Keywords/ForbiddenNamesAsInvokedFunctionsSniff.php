 ...
 * @since 5.5
 */
class ForbiddenNamesAsInvokedFunctionsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokenCode === \T_CATCH) {
            if ($prev !== \false && $tokens[$prev]['code'] === \Dekode\GravityForms\Vendor\T_CLOSE_CURLY_BRACKET) {
                // Ok, it's fine.
                return;
            }
        }
