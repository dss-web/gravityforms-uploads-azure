 ...
 */
class NewKeywordsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $nextToken = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $end + 1, null, \true);
     ...
     * @return bool
     */
    public function isNotQuoted(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
