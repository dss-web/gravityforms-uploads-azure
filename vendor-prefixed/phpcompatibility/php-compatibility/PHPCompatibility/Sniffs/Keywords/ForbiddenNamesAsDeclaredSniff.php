 ...
 */
class ForbiddenNamesAsDeclaredSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
     ...
     * @var array
     */
    protected $forbiddenTokens = array(\Dekode\GravityForms\Vendor\T_NULL => '7.0', \Dekode\GravityForms\Vendor\T_TRUE => '7.0', \Dekode\GravityForms\Vendor\T_FALSE => '7.0');
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (\in_array($tokenType, array('T_CLASS', 'T_INTERFACE', 'T_TRAIT'), \true)) {
            ...
            if ($nextNonEmptyCode !== \T_STRING && isset($this->forbiddenTokens[$nextNonEmptyCode]) === \true) {
                ...
                $endOfStatement = $phpcsFile->findNext(array(\Dekode\GravityForms\Vendor\T_SEMICOLON, \Dekode\GravityForms\Vendor\T_OPEN_CURLY_BRACKET), $stackPtr + 1);
                ...
                do {
                    ...
                    $nextNonEmpty = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $nextNonEmpty + 1, $endOfStatement, \true);
