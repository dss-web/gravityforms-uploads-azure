 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\TypeCasts;
 ...
 * @since 8.0.1
 */
class NewTypeCastsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
    ...
    public function register()
    {
         ...
         */
        if (\version_compare(\Dekode\GravityForms\Vendor\PHPCompatibility\PHPCSHelper::getVersion(), '3.4.0', '<') === \true) {
