 ...
 */
namespace Dekode\GravityForms\Vendor\PHPCompatibility\Sniffs\LanguageConstructs;
 ...
 */
class NewEmptyNonVariableSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $open = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $stackPtr + 1, null, \true, null, \true);
        if ($open === \false || $tokens[$open]['code'] !== \Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS || isset($tokens[$open]['parenthesis_closer']) === \false) {
            return;
        }
