 ...
 */
class NewOperatorsSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractNewFeatureSniff
{
    /**
     ...
     */
    protected $newOperatorsPHPCSCompat = array('T_POW' => \Dekode\GravityForms\Vendor\T_MULTIPLY, 'T_POW_EQUAL' => \T_MUL_EQUAL, 'T_SPACESHIP' => \Dekode\GravityForms\Vendor\T_GREATER_THAN, 'T_COALESCE' => \Dekode\GravityForms\Vendor\T_INLINE_THEN, 'T_COALESCE_EQUAL' => \Dekode\GravityForms\Vendor\T_EQUAL);
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($this->newOperators[$tokenType]) === \false) {
            ...
            if (isset($tokens[$stackPtr + 1]) !== \false && $tokens[$stackPtr + 1]['code'] === \Dekode\GravityForms\Vendor\T_EQUAL) {
    ...
    {
        if ($tokens[$stackPtr]['code'] !== \Dekode\GravityForms\Vendor\T_EQUAL || isset($tokens[$stackPtr - 1]) === \false) {
    ...
    {
        if ($tokens[$stackPtr]['code'] !== \Dekode\GravityForms\Vendor\T_INLINE_THEN || isset($tokens[$stackPtr - 1]) === \false) {
            // Function called for wrong token or token has no predecessor.
            return \false;
        }
        if ($tokens[$stackPtr - 1]['code'] === \Dekode\GravityForms\Vendor\T_INLINE_THEN) {
