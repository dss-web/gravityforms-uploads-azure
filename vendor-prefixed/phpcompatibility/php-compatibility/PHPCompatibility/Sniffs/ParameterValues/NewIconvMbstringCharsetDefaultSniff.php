 ...
 * @since 9.3.0
 */
class NewIconvMbstringCharsetDefaultSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractFunctionCallParameterSniff
{
    /**
     ...
     *                  normal file processing.
     */
    public function processIconvMimeEncode(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $functionName, $parameters)
    {
        ...
        $firstNonEmpty = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens, $targetParam['start'], $targetParam['end'] + 1, \true);
        if ($firstNonEmpty === \false) {
            // Parse error or live coding.
            return;
        }
        if ($tokens[$firstNonEmpty]['code'] === \T_ARRAY || $tokens[$firstNonEmpty]['code'] === \Dekode\GravityForms\Vendor\T_OPEN_SHORT_ARRAY) {
