 ...
 * @since 9.3.0
 */
class RemovedMbStrrposEncodingThirdParamSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\AbstractFunctionCallParameterSniff
{
    /**
     ...
     * @var array
     */
    private $textStringTokens = array(\T_CONSTANT_ENCAPSED_STRING, \Dekode\GravityForms\Vendor\T_DOUBLE_QUOTED_STRING, \Dekode\GravityForms\Vendor\T_HEREDOC, \Dekode\GravityForms\Vendor\T_NOWDOC);
    /**
     ...
     * @var array
     */
    private $numberTokens = array(\T_LNUMBER => \T_LNUMBER, \T_DNUMBER => \T_DNUMBER, \Dekode\GravityForms\Vendor\T_MINUS => \Dekode\GravityForms\Vendor\T_MINUS, \Dekode\GravityForms\Vendor\T_PLUS => \Dekode\GravityForms\Vendor\T_PLUS);
    /**
    ...
    public function processParameters(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $functionName, $parameters)
    {
        ...
        $targets = $this->numberTokens + \Dekode\GravityForms\Vendor\PHP_CodeSniffer_Tokens::$emptyTokens;
