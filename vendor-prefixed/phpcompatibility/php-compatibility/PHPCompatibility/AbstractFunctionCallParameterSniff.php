 ...
 * @since 8.2.0
 */
abstract class AbstractFunctionCallParameterSniff extends \Dekode\GravityForms\Vendor\PHPCompatibility\Sniff
{
    /**
     ...
     *                  normal file processing.
     */
    public abstract function processParameters(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $functionName, $parameters);
    /**
     ...
     *                  normal file processing.
     */
    public function processNoParameters(\Dekode\GravityForms\Vendor\PHP_CodeSniffer_File $phpcsFile, $stackPtr, $functionName)
    {
        return;
    }
}
