...
class PHPCSHelper
{
     ...
     */
    public static function get_tab_width(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile)
    {
        $tab_width = 4;
     ...
     */
    public static function ignore_annotations(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile = null)
    {
        if (isset($phpcsFile, $phpcsFile->config->annotations)) {
            return !$phpcsFile->config->annotations;
        } else {
            $annotations = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getConfigData('annotations');
