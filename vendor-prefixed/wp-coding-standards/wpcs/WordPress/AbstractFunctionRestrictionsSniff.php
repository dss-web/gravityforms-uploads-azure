 ...
 */
abstract class AbstractFunctionRestrictionsSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
     * Exclude groups.
     *
    ...
    public function is_targetted_token($stackPtr)
    {
        ...
        if (\T_STRING === $this->tokens[$prev]['code'] && 'function' === $this->tokens[$prev]['content'] && (\T_AS === $this->tokens[$next]['code'] || \Dekode\GravityForms\Vendor\T_SEMICOLON === $this->tokens[$next]['code'])) {
            return \true;
        }
