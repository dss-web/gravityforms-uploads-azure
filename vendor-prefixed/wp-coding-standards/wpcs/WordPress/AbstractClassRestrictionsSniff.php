...
use Dekode\GravityForms\Vendor\WordPressCS\WordPress\AbstractFunctionRestrictionsSniff;
/**
 ...
 * @since   0.10.0
 */
abstract class AbstractClassRestrictionsSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\AbstractFunctionRestrictionsSniff
{
    /**
    ...
    */
    ...
    public function is_targetted_token($stackPtr)
    {
        ...
        if (\in_array($token['code'], array(\T_NEW, \T_EXTENDS, \T_IMPLEMENTS), \true)) {
            if (\T_NEW === $token['code']) {
                $nameEnd = $this->phpcsFile->findNext(array(\Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS, \T_WHITESPACE, \Dekode\GravityForms\Vendor\T_SEMICOLON, \T_OBJECT_OPERATOR), $stackPtr + 2) - 1;
            } else {
                $nameEnd = $this->phpcsFile->findNext(array(\Dekode\GravityForms\Vendor\T_CLOSE_CURLY_BRACKET, \T_WHITESPACE), $stackPtr + 2) - 1;
            }
