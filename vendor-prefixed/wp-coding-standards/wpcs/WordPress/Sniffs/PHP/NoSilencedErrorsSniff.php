 ...
 * @since   1.1.0
 */
class NoSilencedErrorsSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
    ...
    {
        $this->empty_tokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        $this->empty_tokens[\T_NS_SEPARATOR] = \T_NS_SEPARATOR;
        $this->empty_tokens[\Dekode\GravityForms\Vendor\T_BITWISE_AND] = \Dekode\GravityForms\Vendor\T_BITWISE_AND;
        return array(\Dekode\GravityForms\Vendor\T_ASPERAND);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        if (\false !== $next_non_empty && \T_STRING === $this->tokens[$next_non_empty]['code']) {
            $has_parenthesis = $this->phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $next_non_empty + 1, null, \true, null, \true);
            if (\false !== $has_parenthesis && \Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS === $this->tokens[$has_parenthesis]['code']) {
        ...
        $end_of_statement = $this->phpcsFile->findEndOfStatement($stackPtr, \Dekode\GravityForms\Vendor\T_COMMA);
