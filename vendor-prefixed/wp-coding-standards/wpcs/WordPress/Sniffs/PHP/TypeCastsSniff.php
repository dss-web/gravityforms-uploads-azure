 ...
 */
class TypeCastsSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
    ...
    {
        return array(\T_DOUBLE_CAST, \T_UNSET_CAST, \T_STRING_CAST, \Dekode\GravityForms\Vendor\T_BINARY_CAST);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        switch ($token_code) {
            ...
            case \T_UNSET_CAST:
                ...
                break;
            case \T_STRING_CAST:
            case \Dekode\GravityForms\Vendor\T_BINARY_CAST:
