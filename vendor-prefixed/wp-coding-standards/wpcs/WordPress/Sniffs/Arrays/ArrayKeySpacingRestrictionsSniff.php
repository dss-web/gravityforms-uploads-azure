 ...
 */
class ArrayKeySpacingRestrictionsSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
    ...
    {
        return array(\Dekode\GravityForms\Vendor\T_OPEN_SQUARE_BRACKET);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        $need_spaces = $this->phpcsFile->findNext(array(\T_CONSTANT_ENCAPSED_STRING, \T_LNUMBER, \T_WHITESPACE, \Dekode\GravityForms\Vendor\T_MINUS), $stackPtr + 1, $token['bracket_closer'], \true);
        ...
        if (\false !== $need_spaces && ($spaced1 || $spaced2)) {
            ...
            if ($spaced2) {
                $prev_non_empty = $this->phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $token['bracket_closer'] - 1, null, \true);
