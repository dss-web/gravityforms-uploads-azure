 ...
 * @since   0.14.0
 */
class PrecisionAlignmentSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        $check_tokens = array(\T_WHITESPACE => \true, \T_INLINE_HTML => \true, \Dekode\GravityForms\Vendor\T_DOC_COMMENT_WHITESPACE => \true, \T_COMMENT => \true);
        $check_tokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens;
        for ($i = 0; $i < $this->phpcsFile->numTokens; $i++) {
            ...
            switch ($this->tokens[$i]['type']) {
                ...
                case 'T_DOC_COMMENT_WHITESPACE':
                    ...
                    if (isset($this->tokens[$i + 1]) && (\Dekode\GravityForms\Vendor\T_DOC_COMMENT_STAR === $this->tokens[$i + 1]['code'] || \Dekode\GravityForms\Vendor\T_DOC_COMMENT_CLOSE_TAG === $this->tokens[$i + 1]['code']) && 0 !== $spaces) {
