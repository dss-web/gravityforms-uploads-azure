 ...
 */
namespace Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniffs\Classes;
 ...
 */
class ClassInstantiationSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
    ...
    public function register()
    {
         ...
         */
        $this->classname_tokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        $this->classname_tokens[\T_NS_SEPARATOR] = \T_NS_SEPARATOR;
        $this->classname_tokens[\T_STRING] = \T_STRING;
        $this->classname_tokens[\Dekode\GravityForms\Vendor\T_SELF] = \Dekode\GravityForms\Vendor\T_SELF;
        $this->classname_tokens[\T_STATIC] = \T_STATIC;
        $this->classname_tokens[\Dekode\GravityForms\Vendor\T_PARENT] = \Dekode\GravityForms\Vendor\T_PARENT;
        $this->classname_tokens[\Dekode\GravityForms\Vendor\T_ANON_CLASS] = \Dekode\GravityForms\Vendor\T_ANON_CLASS;
        ...
        $this->classname_tokens[\Dekode\GravityForms\Vendor\T_OPEN_SQUARE_BRACKET] = \Dekode\GravityForms\Vendor\T_OPEN_SQUARE_BRACKET;
        $this->classname_tokens[\Dekode\GravityForms\Vendor\T_CLOSE_SQUARE_BRACKET] = \Dekode\GravityForms\Vendor\T_CLOSE_SQUARE_BRACKET;
    ...
    public function process_token($stackPtr)
    {
        ...
        if ('PHP' === $this->phpcsFile->tokenizerType) {
            $prev_non_empty = $this->phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        for ($classname_ptr = $next_non_empty_after_class_name - 1; $classname_ptr >= $stackPtr; $classname_ptr--) {
            if (!isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$this->tokens[$classname_ptr]['code']])) {
        ...
        if (\Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS !== $this->tokens[$next_non_empty_after_class_name]['code']) {
