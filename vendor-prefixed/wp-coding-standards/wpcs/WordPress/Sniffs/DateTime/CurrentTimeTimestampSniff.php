 ...
 */
namespace Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniffs\DateTime;
 ...
 * @since   2.2.0
 */
class CurrentTimeTimestampSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\AbstractFunctionParameterSniff
{
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
         ...
         */
        $open_parens = $this->phpcsFile->findNext(\Dekode\GravityForms\Vendor\T_OPEN_PARENTHESIS, $stackPtr);
        ...
        for ($i = $parameters[1]['start']; $i <= $parameters[1]['end']; $i++) {
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$heredocTokens[$this->tokens[$i]['code']])) {
                continue;
            }
            /*
         ...
         */
        $has_comment = $this->phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens, $stackPtr + 1, $close_parens + 1);
