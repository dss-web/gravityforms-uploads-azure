 ...
 */
class ValidHookNameSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\AbstractFunctionParameterSniff
{
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        for ($i = $parameters[1]['start']; $i <= $parameters[1]['end']; $i++) {
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens[$this->tokens[$i]['code']]) !== \false) {
                continue;
            }
            ...
            if (\T_VARIABLE === $this->tokens[$i]['code']) {
                do {
                    $open_bracket = $this->phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $i + 1, null, \true);
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$stringTokens[$this->tokens[$i]['code']]) === \false) {
                continue;
            }
             ...
             */
            if (\Dekode\GravityForms\Vendor\T_DOUBLE_QUOTED_STRING === $this->tokens[$i]['code']) {
