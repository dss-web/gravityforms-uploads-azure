...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\NamingConventions\ValidFunctionNameSniff as PHPCS_PEAR_ValidFunctionNameSniff;
 ...
 */
class ValidFunctionNameSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\NamingConventions\ValidFunctionNameSniff
{
    /**
    ...
    {
        if (\Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff::is_function_deprecated($phpcsFile, $stackPtr) === \true) {
            /*
        ...
        if ($functionNameLc !== $functionName) {
            ...
            $errorData = array($functionName, \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff::get_snake_case_name_suggestion($functionName));
    ...
    protected function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($methodNameLc !== $methodName) {
            ...
            $errorData = array($methodName, $className, \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff::get_snake_case_name_suggestion($methodName));
