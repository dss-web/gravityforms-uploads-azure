 ...
 */
class ValidatedSanitizedInputSniff extends \Dekode\GravityForms\Vendor\WordPressCS\WordPress\Sniff
{
    /**
    ...
    {
        return array(\T_VARIABLE, \Dekode\GravityForms\Vendor\T_DOUBLE_QUOTED_STRING, \Dekode\GravityForms\Vendor\T_HEREDOC);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        if (\Dekode\GravityForms\Vendor\T_DOUBLE_QUOTED_STRING === $this->tokens[$stackPtr]['code'] || \Dekode\GravityForms\Vendor\T_HEREDOC === $this->tokens[$stackPtr]['code']) {
        ...
        for ($i = $stackPtr + 1; $i < $this->phpcsFile->numTokens; $i++) {
            ...
            if (\Dekode\GravityForms\Vendor\T_OPEN_SQUARE_BRACKET === $this->tokens[$i]['code'] && isset($this->tokens[$i]['bracket_closer'])) {
