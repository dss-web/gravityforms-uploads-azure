...
use Dekode\GravityForms\Vendor\MicrosoftAzure\Storage\Common\Models\SignedIdentifier;
...
abstract class ACLBase
{
     ...
     * @return AccessPolicy
     */
    protected static abstract function createAccessPolicy();
    /**
     ...
     * @return void
     */
    protected static abstract function validateResourceType($resourceType);
    /**
