...
class Filter extends \RecursiveFilterIterator
{
     ...
     * @return void
     */
    public function __construct($iterator, $basedir, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config $config, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset $ruleset)
    {
    ...
    public function accept()
    {
        ...
        $realPath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::realpath($filePath);
        if ($realPath !== \false) {
