...
abstract class ExactMatch extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Filters\Filter
{
    /**
    ...
    public function accept()
    {
        ...
        $filePath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::realpath($this->current());
