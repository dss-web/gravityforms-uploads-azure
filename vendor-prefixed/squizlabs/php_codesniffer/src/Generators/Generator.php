 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Generators;
...
abstract class Generator
{
     ...
     * @see generate()
     */
    public function __construct(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset $ruleset)
    {
        $this->ruleset = $ruleset;
        foreach ($ruleset->sniffs as $className => $sniffClass) {
            $file = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Autoload::getLoadedFileName($className);
