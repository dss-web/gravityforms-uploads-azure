...
class LocalFile extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File
{
    /**
    ...
    {
        $this->path = \trim($path);
        if (\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::isReadable($this->path) === \false) {
    ...
    public function process()
    {
        ...
        $cache = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Cache::get($this->path);
        ...
        \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Cache::set($this->path, $cache);
