...
class FileList implements \Iterator, \Countable
{
     ...
     * @return void
     */
    public function __construct(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config $config, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset $ruleset)
    {
        $this->ruleset = $ruleset;
        $this->config = $config;
        $paths = $config->files;
        foreach ($paths as $path) {
            $isPharFile = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::isPharFile($path);
    ...
    private function getFilterClass()
    {
        ...
        if ($filterType === null) {
            $filterClass = 'Dekode\\GravityForms\\Vendor\\PHP_CodeSniffer\\Filters\\Filter';
        } else {
            if (\strpos($filterType, '.') !== \false) {
                ...
                $filterClass = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Autoload::loadFile($filename);
            } else {
    ...
    public function current()
    {
        ...
        if (isset($this->files[$path]) === \false) {
            $this->files[$path] = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\LocalFile($path, $this->ruleset, $this->config);
        }
