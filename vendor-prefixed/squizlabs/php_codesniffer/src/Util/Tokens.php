 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util;

\define('Dekode\\GravityForms\\Vendor\\T_NONE', 'PHPCS_T_NONE');
\define('Dekode\\GravityForms\\Vendor\\T_OPEN_CURLY_BRACKET', 'PHPCS_T_OPEN_CURLY_BRACKET');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSE_CURLY_BRACKET', 'PHPCS_T_CLOSE_CURLY_BRACKET');
\define('Dekode\\GravityForms\\Vendor\\T_OPEN_SQUARE_BRACKET', 'PHPCS_T_OPEN_SQUARE_BRACKET');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSE_SQUARE_BRACKET', 'PHPCS_T_CLOSE_SQUARE_BRACKET');
\define('Dekode\\GravityForms\\Vendor\\T_OPEN_PARENTHESIS', 'PHPCS_T_OPEN_PARENTHESIS');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSE_PARENTHESIS', 'PHPCS_T_CLOSE_PARENTHESIS');
\define('Dekode\\GravityForms\\Vendor\\T_COLON', 'PHPCS_T_COLON');
\define('Dekode\\GravityForms\\Vendor\\T_NULLABLE', 'PHPCS_T_NULLABLE');
\define('Dekode\\GravityForms\\Vendor\\T_STRING_CONCAT', 'PHPCS_T_STRING_CONCAT');
\define('Dekode\\GravityForms\\Vendor\\T_INLINE_THEN', 'PHPCS_T_INLINE_THEN');
\define('Dekode\\GravityForms\\Vendor\\T_INLINE_ELSE', 'PHPCS_T_INLINE_ELSE');
\define('Dekode\\GravityForms\\Vendor\\T_NULL', 'PHPCS_T_NULL');
\define('Dekode\\GravityForms\\Vendor\\T_FALSE', 'PHPCS_T_FALSE');
\define('Dekode\\GravityForms\\Vendor\\T_TRUE', 'PHPCS_T_TRUE');
\define('Dekode\\GravityForms\\Vendor\\T_SEMICOLON', 'PHPCS_T_SEMICOLON');
\define('Dekode\\GravityForms\\Vendor\\T_EQUAL', 'PHPCS_T_EQUAL');
\define('Dekode\\GravityForms\\Vendor\\T_MULTIPLY', 'PHPCS_T_MULTIPLY');
\define('Dekode\\GravityForms\\Vendor\\T_DIVIDE', 'PHPCS_T_DIVIDE');
\define('Dekode\\GravityForms\\Vendor\\T_PLUS', 'PHPCS_T_PLUS');
\define('Dekode\\GravityForms\\Vendor\\T_MINUS', 'PHPCS_T_MINUS');
\define('Dekode\\GravityForms\\Vendor\\T_MODULUS', 'PHPCS_T_MODULUS');
\define('Dekode\\GravityForms\\Vendor\\T_BITWISE_AND', 'PHPCS_T_BITWISE_AND');
\define('Dekode\\GravityForms\\Vendor\\T_BITWISE_OR', 'PHPCS_T_BITWISE_OR');
\define('Dekode\\GravityForms\\Vendor\\T_BITWISE_XOR', 'PHPCS_T_BITWISE_XOR');
\define('Dekode\\GravityForms\\Vendor\\T_BITWISE_NOT', 'PHPCS_T_BITWISE_NOT');
\define('Dekode\\GravityForms\\Vendor\\T_ARRAY_HINT', 'PHPCS_T_ARRAY_HINT');
\define('Dekode\\GravityForms\\Vendor\\T_GREATER_THAN', 'PHPCS_T_GREATER_THAN');
\define('Dekode\\GravityForms\\Vendor\\T_LESS_THAN', 'PHPCS_T_LESS_THAN');
\define('Dekode\\GravityForms\\Vendor\\T_BOOLEAN_NOT', 'PHPCS_T_BOOLEAN_NOT');
\define('Dekode\\GravityForms\\Vendor\\T_SELF', 'PHPCS_T_SELF');
\define('Dekode\\GravityForms\\Vendor\\T_PARENT', 'PHPCS_T_PARENT');
\define('Dekode\\GravityForms\\Vendor\\T_DOUBLE_QUOTED_STRING', 'PHPCS_T_DOUBLE_QUOTED_STRING');
\define('Dekode\\GravityForms\\Vendor\\T_COMMA', 'PHPCS_T_COMMA');
\define('Dekode\\GravityForms\\Vendor\\T_HEREDOC', 'PHPCS_T_HEREDOC');
\define('Dekode\\GravityForms\\Vendor\\T_PROTOTYPE', 'PHPCS_T_PROTOTYPE');
\define('Dekode\\GravityForms\\Vendor\\T_THIS', 'PHPCS_T_THIS');
\define('Dekode\\GravityForms\\Vendor\\T_REGULAR_EXPRESSION', 'PHPCS_T_REGULAR_EXPRESSION');
\define('Dekode\\GravityForms\\Vendor\\T_PROPERTY', 'PHPCS_T_PROPERTY');
\define('Dekode\\GravityForms\\Vendor\\T_LABEL', 'PHPCS_T_LABEL');
\define('Dekode\\GravityForms\\Vendor\\T_OBJECT', 'PHPCS_T_OBJECT');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSE_OBJECT', 'PHPCS_T_CLOSE_OBJECT');
\define('Dekode\\GravityForms\\Vendor\\T_COLOUR', 'PHPCS_T_COLOUR');
\define('Dekode\\GravityForms\\Vendor\\T_HASH', 'PHPCS_T_HASH');
\define('Dekode\\GravityForms\\Vendor\\T_URL', 'PHPCS_T_URL');
\define('Dekode\\GravityForms\\Vendor\\T_STYLE', 'PHPCS_T_STYLE');
\define('Dekode\\GravityForms\\Vendor\\T_ASPERAND', 'PHPCS_T_ASPERAND');
\define('Dekode\\GravityForms\\Vendor\\T_DOLLAR', 'PHPCS_T_DOLLAR');
\define('Dekode\\GravityForms\\Vendor\\T_TYPEOF', 'PHPCS_T_TYPEOF');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSURE', 'PHPCS_T_CLOSURE');
\define('Dekode\\GravityForms\\Vendor\\T_ANON_CLASS', 'PHPCS_T_ANON_CLASS');
\define('Dekode\\GravityForms\\Vendor\\T_BACKTICK', 'PHPCS_T_BACKTICK');
\define('Dekode\\GravityForms\\Vendor\\T_START_NOWDOC', 'PHPCS_T_START_NOWDOC');
\define('Dekode\\GravityForms\\Vendor\\T_NOWDOC', 'PHPCS_T_NOWDOC');
\define('Dekode\\GravityForms\\Vendor\\T_END_NOWDOC', 'PHPCS_T_END_NOWDOC');
\define('Dekode\\GravityForms\\Vendor\\T_OPEN_SHORT_ARRAY', 'PHPCS_T_OPEN_SHORT_ARRAY');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSE_SHORT_ARRAY', 'PHPCS_T_CLOSE_SHORT_ARRAY');
\define('Dekode\\GravityForms\\Vendor\\T_GOTO_LABEL', 'PHPCS_T_GOTO_LABEL');
\define('Dekode\\GravityForms\\Vendor\\T_BINARY_CAST', 'PHPCS_T_BINARY_CAST');
\define('Dekode\\GravityForms\\Vendor\\T_EMBEDDED_PHP', 'PHPCS_T_EMBEDDED_PHP');
\define('Dekode\\GravityForms\\Vendor\\T_RETURN_TYPE', 'PHPCS_T_RETURN_TYPE');
\define('Dekode\\GravityForms\\Vendor\\T_OPEN_USE_GROUP', 'PHPCS_T_OPEN_USE_GROUP');
\define('Dekode\\GravityForms\\Vendor\\T_CLOSE_USE_GROUP', 'PHPCS_T_CLOSE_USE_GROUP');
\define('Dekode\\GravityForms\\Vendor\\T_ZSR', 'PHPCS_T_ZSR');
\define('Dekode\\GravityForms\\Vendor\\T_ZSR_EQUAL', 'PHPCS_T_ZSR_EQUAL');
\define('Dekode\\GravityForms\\Vendor\\T_FN_ARROW', 'PHPCS_T_FN_ARROW');
\define('Dekode\\GravityForms\\Vendor\\T_TYPE_UNION', 'PHPCS_T_TYPE_UNION');
\define('Dekode\\GravityForms\\Vendor\\T_PARAM_NAME', 'PHPCS_T_PARAM_NAME');
\define('Dekode\\GravityForms\\Vendor\\T_MATCH_ARROW', 'PHPCS_T_MATCH_ARROW');
\define('Dekode\\GravityForms\\Vendor\\T_MATCH_DEFAULT', 'PHPCS_T_MATCH_DEFAULT');
\define('Dekode\\GravityForms\\Vendor\\T_ATTRIBUTE_END', 'PHPCS_T_ATTRIBUTE_END');
...
\define('Dekode\\GravityForms\\Vendor\\T_DOC_COMMENT_STAR', 'PHPCS_T_DOC_COMMENT_STAR');
\define('Dekode\\GravityForms\\Vendor\\T_DOC_COMMENT_WHITESPACE', 'PHPCS_T_DOC_COMMENT_WHITESPACE');
\define('Dekode\\GravityForms\\Vendor\\T_DOC_COMMENT_TAG', 'PHPCS_T_DOC_COMMENT_TAG');
\define('Dekode\\GravityForms\\Vendor\\T_DOC_COMMENT_OPEN_TAG', 'PHPCS_T_DOC_COMMENT_OPEN_TAG');
\define('Dekode\\GravityForms\\Vendor\\T_DOC_COMMENT_CLOSE_TAG', 'PHPCS_T_DOC_COMMENT_CLOSE_TAG');
\define('Dekode\\GravityForms\\Vendor\\T_DOC_COMMENT_STRING', 'PHPCS_T_DOC_COMMENT_STRING');
// Tokens used for PHPCS instruction comments.
\define('Dekode\\GravityForms\\Vendor\\T_PHPCS_ENABLE', 'PHPCS_T_PHPCS_ENABLE');
\define('Dekode\\GravityForms\\Vendor\\T_PHPCS_DISABLE', 'PHPCS_T_PHPCS_DISABLE');
\define('Dekode\\GravityForms\\Vendor\\T_PHPCS_SET', 'PHPCS_T_PHPCS_SET');
\define('Dekode\\GravityForms\\Vendor\\T_PHPCS_IGNORE', 'PHPCS_T_PHPCS_IGNORE');
\define('Dekode\\GravityForms\\Vendor\\T_PHPCS_IGNORE_FILE', 'PHPCS_T_PHPCS_IGNORE_FILE');
final class Tokens
{
    /**
