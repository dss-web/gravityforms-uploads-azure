...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Autoload;
...
class Cache
{
     ...
     * @return void
     */
    public static function load(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset $ruleset, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config $config)
    {
        ...
        $codeHashFiles = [];
        $classes = \array_keys(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Autoload::getLoadedClasses());
        \sort($classes);
        ...
        $filter = new \RecursiveCallbackFilterIterator($di, function ($file, $key, $iterator) {
            ...
            $filePath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::realpath($key);
            if ($filePath === \false) {
                return \false;
            }
        ...
        $configData = ['phpVersion' => \PHP_VERSION_ID, 'phpExtensions' => $phpExtensionsHash, 'tabWidth' => $config->tabWidth, 'encoding' => $config->encoding, 'recordErrors' => $config->recordErrors, 'annotations' => $config->annotations, 'configData' => \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getAllConfigData(), 'codeHash' => $codeHash, 'rulesetHash' => $rulesetHash];
        ...
        if ($config->cacheFile !== null) {
            ...
            foreach ($config->files as $file) {
                $file = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::realpath($file);
