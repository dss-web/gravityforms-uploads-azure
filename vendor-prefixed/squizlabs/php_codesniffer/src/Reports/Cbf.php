...
class Cbf implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Reports\Report
{
    /**
    ...
    public function generateFileReport($report, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $showSources = \false, $width = 80)
    {
        ...
        if ($phpcsFile->config->stdin === \true) {
            ...
            throw new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Exceptions\DeepExitException($fixedContent, 1);
        }
        if ($errors === 0) {
            return \false;
        }
