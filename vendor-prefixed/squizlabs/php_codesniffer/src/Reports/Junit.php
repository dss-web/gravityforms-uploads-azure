...
class Junit implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Reports\Report
{
    /**
    ...
    public function generate($cachedData, $totalFiles, $totalErrors, $totalWarnings, $totalFixable, $showSources = \false, $width = 80, $interactive = \false, $toScreen = \true)
    {
        ...
        echo '<testsuites name="PHP_CodeSniffer ' . \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::VERSION . '" errors="0" tests="' . $tests . '" failures="' . $failures . '">' . \PHP_EOL;
        echo $cachedData;
