...
class Checkstyle implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Reports\Report
{
    /**
    ...
    public function generate($cachedData, $totalFiles, $totalErrors, $totalWarnings, $totalFixable, $showSources = \false, $width = 80, $interactive = \false, $toScreen = \true)
    {
        ...
        echo '<checkstyle version="' . \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::VERSION . '">' . \PHP_EOL;
        echo $cachedData;
