 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Reports;
...
class Notifysend implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Reports\Report
{
    /**
    ...
    {
        $path = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getExecutablePath('notifysend');
        if ($path !== null) {
            $this->path = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::escapeshellcmd($path);
        }
        $timeout = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getConfigData('notifysend_timeout');
        if ($timeout !== null) {
            $this->timeout = (int) $timeout;
        }
        $showOk = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getConfigData('notifysend_showok');
        if ($showOk !== null) {
     ...
     * @return bool
     */
    public function generateFileReport($report, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $showSources = \false, $width = 80)
    {
