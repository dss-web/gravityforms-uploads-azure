...
abstract class AbstractScopeSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processTokenOutsideScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr);
}
//end class
