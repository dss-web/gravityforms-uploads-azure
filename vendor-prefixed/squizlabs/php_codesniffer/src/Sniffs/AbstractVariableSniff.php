...
abstract class AbstractVariableSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
    ...
    {
        $scopes = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens;
     ...
     */
    protected final function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        foreach ($conditions as $scope => $code) {
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens[$code]) === \true) {
                break;
            }
        ...
        if ($inFunction === \false && isset($tokens[$stackPtr]['nested_parenthesis']) === \true) {
            foreach ($tokens[$stackPtr]['nested_parenthesis'] as $opener => $closer) {
                if (isset($tokens[$opener]['parenthesis_owner']) === \false) {
                    ...
                    $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $opener - 1, null, \true);
     ...
     *                  the rest of the file.
     */
    protected final function processTokenOutsideScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     *                  the rest of the file.
     */
    protected abstract function processMemberVar(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processVariable(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processVariableInString(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr);
}
//end class
