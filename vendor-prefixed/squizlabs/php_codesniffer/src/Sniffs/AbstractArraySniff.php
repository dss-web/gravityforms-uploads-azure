...
abstract class AbstractArraySniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $lastContent = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $arrayEnd - 1, null, \true);
        ...
        $indices = [];
        $current = $arrayStart;
        while (($next = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $current + 1, $arrayEnd, \true)) !== \false) {
            ...
            if ($tokens[$end]['code'] === \T_DOUBLE_ARROW) {
                ...
                $valueStart = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $end + 1, null, \true);
     ...
     * @return int
     */
    private function getNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $ptr, $arrayEnd)
    {
        $tokens = $phpcsFile->getTokens();
        while ($ptr < $arrayEnd) {
