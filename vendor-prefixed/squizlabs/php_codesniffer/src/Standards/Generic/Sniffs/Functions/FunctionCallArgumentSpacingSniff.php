 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions;
...
class FunctionCallArgumentSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $ignoreTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        ...
        $openBracket = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $functionName + 1, null, \true);
     ...
     * @return void
     */
    public function checkSpacing(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $openBracket)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        while (($nextSeparator = $phpcsFile->findNext($find, $nextSeparator + 1, $closeBracket)) !== \false) {
            ...
            if ($tokens[$nextSeparator]['code'] === T_COMMA) {
                if ($tokens[$nextSeparator - 1]['code'] === \T_WHITESPACE) {
                    $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextSeparator - 2, null, \true);
                    if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$heredocTokens[$tokens[$prev]['code']]) === \false) {
                ...
                if ($tokens[$nextSeparator + 1]['code'] !== \T_WHITESPACE) {
                    ...
                    $next = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextSeparator + 1, null, \true);
