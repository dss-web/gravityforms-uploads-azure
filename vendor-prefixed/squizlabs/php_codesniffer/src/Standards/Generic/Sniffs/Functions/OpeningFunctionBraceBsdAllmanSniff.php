...
class OpeningFunctionBraceBsdAllmanSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $openingBrace - 1, $closeBracket, \true);
        ...
        if ($lineDifference === 0) {
            ...
            if ($fix === \true) {
                ...
                for ($nextLine = $openingBrace + 1; $nextLine < $phpcsFile->numTokens; $nextLine++) {
                    ...
                    if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens[$tokens[$nextLine]['code']]) === \true) {
        ...
        //end if
        $ignore = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens;
        $ignore[] = \T_WHITESPACE;
