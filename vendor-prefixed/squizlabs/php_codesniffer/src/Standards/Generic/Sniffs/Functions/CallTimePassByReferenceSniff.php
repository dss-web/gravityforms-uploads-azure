...
class CallTimePassByReferenceSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $findTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        ...
        while (($nextSeparator = $phpcsFile->findNext($find, $nextSeparator + 1, $closeBracket)) !== \false) {
            ...
            $tokenBefore = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextSeparator - 1, null, \true);
            if ($tokens[$tokenBefore]['code'] === T_BITWISE_AND) {
                ...
                $tokenBefore = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $tokenBefore - 1, null, \true);
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$assignmentTokens[$tokens[$tokenBefore]['code']]) === \true) {
                    continue;
                }
