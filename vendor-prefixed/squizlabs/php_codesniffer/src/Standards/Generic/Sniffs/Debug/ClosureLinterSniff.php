...
class ClosureLinterSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $lintPath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getExecutablePath('gjslint');
        if ($lintPath === null) {
            return;
        }
        $fileName = $phpcsFile->getFilename();
        $lintPath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::escapeshellcmd($lintPath);
