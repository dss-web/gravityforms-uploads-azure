...
class ESLintSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $eslintPath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getExecutablePath('eslint');
        if ($eslintPath === null) {
            return;
        }
        ...
        $cmd = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::escapeshellcmd(\escapeshellarg($eslintPath) . ' ' . \implode(' ', $eslintOptions) . ' ' . \escapeshellarg($filename));
        // Execute!
