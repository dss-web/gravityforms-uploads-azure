 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\ControlStructures;
...
class DisallowYodaConditionsSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        return \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$comparisonTokens;
    }
    //end register()
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $previousIndex = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        $prevIndex = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $previousIndex - 1, null, \true);
        if ($prevIndex === \false) {
            return;
        }
        if (\in_array($tokens[$prevIndex]['code'], \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$arithmeticTokens, \true) === \true) {
            return;
        }
        ...
        if ($tokens[$previousIndex]['code'] === T_CLOSE_PARENTHESIS) {
            ...
            $closeParenthesisIndex = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $tokens[$previousIndex]['parenthesis_opener'] - 1, null, \true);
            if ($closeParenthesisIndex === \false || $tokens[$closeParenthesisIndex]['code'] !== \T_ARRAY) {
                ...
                $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $previousIndex - 1, $opener + 1, \true);
                if ($prev === \false) {
                    return;
                }
            } else {
     ...
     * @return bool
     */
    public function isArrayStatic(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $arrayToken)
    {
        $tokens = $phpcsFile->getTokens();
        $arrayEnd = null;
        ...
        $staticTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$textStringTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$equalityTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$comparisonTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$arithmeticTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$operators;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$booleanOperators;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$castTokens;
        $staticTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$bracketTokens;
