...
class DisallowAlternativePHPTagsSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
     ...
     */
    protected function findClosingTag(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $tokens, $stackPtr, $content)
    {
     ...
     * @return void
     */
    protected function addChangeset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $tokens, $openTagPointer, $closeTagPointer, $echo = \false)
    {
