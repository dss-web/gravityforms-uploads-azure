...
class LowerCaseTypeSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $tokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$castTokens;
        $tokens[] = \T_FUNCTION;
        $tokens[] = T_CLOSURE;
        $tokens[] = \T_VARIABLE;
        return $tokens;
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$castTokens[$tokens[$stackPtr]['code']]) === \true) {
            // A cast token.
     ...
     * @return void
     */
    protected function processUnionType(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $typeDeclStart, $typeDeclEnd, $error, $errorCode)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        do {
            ...
            $startOfType = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $current, $endOfType, \true);
     ...
     * @return void
     */
    protected function processType(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $type, $error, $errorCode)
    {
