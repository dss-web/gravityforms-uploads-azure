...
class LowerCaseKeywordSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (\strtolower($keyword) !== $keyword) {
            ...
            $messageKeyword = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::prepareForOutput($keyword);
