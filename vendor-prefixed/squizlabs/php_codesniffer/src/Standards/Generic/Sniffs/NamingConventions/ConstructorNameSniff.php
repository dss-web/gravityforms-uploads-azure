...
class ConstructorNameSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return void
     */
    protected function loadFunctionNamesInScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $currScope)
    {
        $this->functionList = [];
        $tokens = $phpcsFile->getTokens();
