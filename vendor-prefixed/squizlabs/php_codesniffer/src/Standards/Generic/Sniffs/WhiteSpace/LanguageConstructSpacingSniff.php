...
class LanguageConstructSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \T_YIELD_FROM && \strtolower($content) !== 'yield from') {
            ...
            $data = [\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::prepareForOutput($found)];
        ...
        if ($tokens[$stackPtr + 1]['code'] === \T_WHITESPACE) {
            ...
            if ($content !== ' ') {
                ...
                $data = [\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::prepareForOutput($content)];
