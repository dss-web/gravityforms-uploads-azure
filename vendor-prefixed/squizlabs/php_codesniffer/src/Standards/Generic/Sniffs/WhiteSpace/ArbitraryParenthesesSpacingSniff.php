...
class ArbitraryParenthesesSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $this->ignoreTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$functionNameTokens;
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $preOpener = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $opener - 1, null, \true);
