 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Arrays;

use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractArraySniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class ArrayIndentSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractArraySniff
{
    /**
    ...
    public function processMultiLineArray($phpcsFile, $stackPtr, $arrayStart, $arrayEnd, $indices)
    {
        ...
        foreach ($indices as $index) {
            ...
            $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $start - 1, null, \true);
