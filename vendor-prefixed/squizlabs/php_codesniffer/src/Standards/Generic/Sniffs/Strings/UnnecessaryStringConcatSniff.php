 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Strings;
...
class UnnecessaryStringConcatSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$prev]['code']]) === \true && isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$next]['code']]) === \true) {
