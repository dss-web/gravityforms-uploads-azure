...
class SpaceAfterCastSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        return \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$castTokens;
    }
    //end register()
    /**
