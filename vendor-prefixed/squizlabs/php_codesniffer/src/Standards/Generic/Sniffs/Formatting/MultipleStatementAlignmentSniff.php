 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Formatting;
...
class MultipleStatementAlignmentSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $tokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
    ...
    public function checkAlignment($phpcsFile, $stackPtr, $end = null)
    {
        ...
        $find = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
        unset($find[\T_DOUBLE_ARROW]);
        $scopes = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$scopeOpeners;
        ...
        for ($assign = $stackPtr; $assign < $end; $assign++) {
            ...
            if (isset($find[$tokens[$assign]['code']]) === \false) {
                ...
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$assign]['code']]) === \false && $tokens[$assign]['line'] - $tokens[$lastCode]['line'] > 1 && $tokens[$assign]['level'] === $tokens[$stackPtr]['level'] && $arrayEnd === null) {
                    break;
                }
                ...
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$assign]['code']]) === \false) {
                    $lastCode = $assign;
            ...
            //end if
            $var = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $assign - 1, null, \true);
