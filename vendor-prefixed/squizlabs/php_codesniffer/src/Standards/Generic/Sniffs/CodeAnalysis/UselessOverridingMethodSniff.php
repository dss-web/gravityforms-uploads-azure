...
class UselessOverridingMethodSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
            ...
            if ($code === T_OPEN_PARENTHESIS) {
                ...
                if ($code === T_CLOSE_PARENTHESIS) {
                    ...
                    if ($parenthesisCount === 1 && $code === T_COMMA) {
                        ...
                        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$code]) === \false) {
