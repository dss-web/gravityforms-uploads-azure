 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\CodeAnalysis;
...
class UnusedFunctionParameterSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $validTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        for (; $next <= $end; ++$next) {
            $token = $tokens[$next];
            $code = $token['code'];
            // Ignorable tokens.
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$code]) === \true) {
                continue;
            }
            if ($foundContent === \false) {
                ...
                if ($code === \T_RETURN) {
                    $tmp = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $next + 1, null, \true);
                    ...
                    $tmp = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $tmp + 1, null, \true);
