 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR12\Sniffs\Files;
...
class FileHeaderSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $possibleHeaders = [];
        $searchFor = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens;
        ...
        do {
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens[$tokens[$next]['code']]) === \true) {
     ...
     * @return array
     */
    public function getHeaderLines(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        $foundDocblock = \false;
        $commentOpeners = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$scopeOpeners;
            ...
            switch ($tokens[$next]['code']) {
                case T_DOC_COMMENT_OPEN_TAG:
                    ...
                    for ($docToken = $end + 1; $docToken < $phpcsFile->numTokens; $docToken++) {
                        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$docToken]['code']]) === \true) {
                            continue;
                        }
                    ...
                    if (isset($commentOpeners[$tokens[$docToken]['code']]) === \false && isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$methodPrefixes[$tokens[$docToken]['code']]) === \false) {
                ...
                case \T_USE:
                    $type = 'use';
                    $useType = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $next + 1, null, \true);
                ...
                default:
                    ...
                    if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens[$tokens[$next]['code']]) === \true) {
                        $next = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens, $next + 1, null, \true);
                        if ($next === \false) {
     ...
     * @return int|null
     */
    public function processHeaderLines(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $headerLines)
    {
        $tokens = $phpcsFile->getTokens();
        $found = [];
