 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR12\Sniffs\Classes;

use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\FunctionCallArgumentSpacingSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\Functions\MultiLineFunctionDeclarationSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class AnonClassDeclarationSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $this->multiLineSniff = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\Functions\MultiLineFunctionDeclarationSniff();
        $this->functionCallSniff = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\FunctionCallArgumentSpacingSniff();
     ...
     * @return void
     */
    public function processSingleLineArgumentList(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        $openBracket = $tokens[$stackPtr]['parenthesis_opener'];
     ...
     * @return void
     */
    public function processMultiLineArgumentList(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        $openBracket = $tokens[$stackPtr]['parenthesis_opener'];
