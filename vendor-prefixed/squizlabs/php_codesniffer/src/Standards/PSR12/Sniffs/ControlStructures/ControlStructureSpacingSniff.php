 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR12\Sniffs\ControlStructures;

use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\ControlStructures\ControlStructureSpacingSniff as PSR2Spacing;
...
class ControlStructureSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$parenOpener]['line'] === $tokens[$parenCloser]['line']) {
            ...
            $sniff = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\ControlStructures\ControlStructureSpacingSniff();
        ...
        for ($i = $parenOpener; $i < $parenCloser; $i++) {
            if ($tokens[$i]['column'] !== 1 || $tokens[$i + 1]['line'] > $tokens[$i]['line'] || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens[$tokens[$i]['code']]) === \true) {
                continue;
            }
            if ($i + 1 === $parenCloser) {
                break;
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$textStringTokens[$tokens[$i]['code']]) === \true || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$heredocTokens[$tokens[$i]['code']]) === \true) {
                continue;
            }
