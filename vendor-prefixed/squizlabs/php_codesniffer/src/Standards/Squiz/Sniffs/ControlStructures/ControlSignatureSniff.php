 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\ControlStructures;
...
class ControlSignatureSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $nextNonEmpty = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr + 1, null, \true);
        ...
        if (isset($tokens[$stackPtr]['scope_opener']) === \true) {
            ...
            for ($next = $opener + 1; $next < $phpcsFile->numTokens; $next++) {
                ...
                if ($tokens[$next]['line'] === $tokens[$opener]['line'] && (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$code]) === \true || $code === \T_CLOSE_TAG)) {
                    continue;
                }
            ...
            if ($tokens[$stackPtr]['code'] === \T_WHILE) {
                ...
                $closer = $tokens[$stackPtr]['parenthesis_closer'];
                $nextNonEmpty = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $closer + 1, null, \true);
        ...
        if ($tokens[$stackPtr]['code'] === \T_WHILE) {
            ...
            $closer = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        if ($found !== 1) {
            ...
            $data = [$found];
            if ($phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens, $closer + 1, $stackPtr) !== \false) {
