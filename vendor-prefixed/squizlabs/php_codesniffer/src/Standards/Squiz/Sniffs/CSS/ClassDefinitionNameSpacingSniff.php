...
class ClassDefinitionNameSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $endTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens;
