...
class LowercaseFunctionKeywordsSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $tokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$methodPrefixes;
        $tokens[] = \T_FUNCTION;
        $tokens[] = T_CLOSURE;
        $tokens[] = \T_FN;
        return $tokens;
