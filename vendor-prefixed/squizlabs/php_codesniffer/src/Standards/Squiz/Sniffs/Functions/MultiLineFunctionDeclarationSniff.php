...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Functions\FunctionDeclarationSniff as PEARFunctionDeclarationSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class MultiLineFunctionDeclarationSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Functions\FunctionDeclarationSniff
{
    /**
    ...
    public function processSingleLineDeclaration($phpcsFile, $stackPtr, $tokens)
    {
        ...
        if ($tokens[$prevNonWhiteSpace]['line'] !== $tokens[$closingBracket]['line']) {
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$prevNonWhiteSpace]['code']]) === \true) {
