...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff as PSR2ClassDeclarationSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class ClassDeclarationSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff
{
    /**
    ...
    public function processClose(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        for ($nextContent = $closeBrace + 1; $nextContent < $phpcsFile->numTokens; $nextContent++) {
            ...
            if ($tokens[$nextContent]['line'] === $tokens[$closeBrace]['line'] && ($tokens[$nextContent]['code'] === \T_WHITESPACE || $tokens[$nextContent]['code'] === \T_COMMENT || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens[$tokens[$nextContent]['code']]) === \true)) {
                continue;
            }
