...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class SelfMemberReferenceSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return void
     */
    protected function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        $calledClassName = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        if ($tokens[$calledClassName]['code'] === T_SELF) {
            ...
            if ($tokens[$calledClassName]['code'] === \T_STRING) {
                ...
                $prevNonEmpty = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $calledClassName - 1, null, \true);
                ...
                if ($declarationName === $fullQualifiedClassName) {
                    ...
                    if ($fix === \true) {
                        ...
                        while ($tokens[$currentPointer]['code'] === \T_NS_SEPARATOR || $tokens[$currentPointer]['code'] === \T_STRING || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$currentPointer]['code']]) === \true) {
                            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$currentPointer]['code']]) === \true) {
                                --$currentPointer;
                                continue;
                            }
     ...
     * @return void
     */
    protected function processTokenOutsideScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
    }
     ...
     * @return string
     */
    protected function getNamespaceOfScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $namespace = '\\';
