 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\Arrays;
...
class ArrayDeclarationSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \T_ARRAY) {
            ...
            if ($arrayStart !== $stackPtr + 1) {
                ...
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens[$tokens[$next]['code']]) === \true) {
    ...
    public function processMultiLineArray($phpcsFile, $stackPtr, $arrayStart, $arrayEnd)
    {
        ...
        for ($nextToken = $stackPtr + 1; $nextToken < $arrayEnd; $nextToken++) {
            ...
            if ($tokens[$nextToken]['code'] === T_COMMA) {
                ...
                if ($keyUsed === \false) {
                    if ($tokens[$nextToken - 1]['code'] === \T_WHITESPACE) {
                        $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextToken - 1, null, \true);
                    ...
                    //end if
                    $valueContent = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $lastToken + 1, $nextToken, \true);
            ...
            if ($tokens[$nextToken]['code'] === \T_DOUBLE_ARROW) {
                ...
                $nextContent = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextToken + 1, $arrayEnd, \true);
        ...
        if (empty($indices) === \true) {
            ...
            if (\count($indices) === 1 && $tokens[$lastToken]['code'] === T_COMMA) {
                ...
                $exclude = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
                $exclude[] = T_COMMA;
        ...
        if ($singleValue === \true) {
            ...
            $next = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$heredocTokens, $arrayStart + 1, $arrayEnd - 1);
            if ($next === \false) {
                ...
                $find = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens;
                $find[] = \T_COMMENT;
        ...
        */
        if ($keyUsed === \false && empty($indices) === \false) {
            ...
            $trailingContent = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $arrayEnd - 1, $lastIndex, \true);
            ...
            foreach ($indices as $valuePosition => $value) {
                ...
                $ignoreTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$castTokens;
        ...
        foreach ($indices as $valuePosition => $index) {
            ...
            if ($end === \false) {
                ...
                if ($tokens[$end]['code'] === T_COMMA) {
                    $valueEnd = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $end - 1, $valueStart, \true);
                    $nextComma = $end;
                } else {
                    $valueEnd = $end;
                    $next = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $end + 1, $arrayEnd, \true);
            ...
            if ($nextComma !== \false && $tokens[$nextComma - 1]['code'] === \T_WHITESPACE) {
                ...
                $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextComma - 1, null, \true);
