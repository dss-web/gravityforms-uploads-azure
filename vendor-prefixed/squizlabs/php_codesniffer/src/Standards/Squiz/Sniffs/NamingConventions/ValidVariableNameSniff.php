 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\NamingConventions;
...
class ValidVariableNameSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractVariableSniff
{
    ...
    protected function processVariable(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$objOperator]['code'] === \T_OBJECT_OPERATOR || $tokens[$objOperator]['code'] === \T_NULLSAFE_OBJECT_OPERATOR) {
            ...
            if ($tokens[$var]['code'] === \T_STRING) {
                ...
                if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
                    ...
                    if (\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::isCamelCaps($objVarName, \false, \true, \false) === \false) {
        ...
        if (\substr($varName, 0, 1) === '_') {
            $inClass = $phpcsFile->hasCondition($stackPtr, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens);
            if ($inClass === \true) {
                $varName = \substr($varName, 1);
            }
        }
        if (\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::isCamelCaps($varName, \false, \true, \false) === \false) {
