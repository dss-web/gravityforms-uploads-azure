...
class OperatorSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function register()
    {
        ...
        */
        ...
        $this->nonOperandTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$operators;
        // Trying to compare a negative value; eg. ($var === -1).
        $this->nonOperandTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$comparisonTokens;
        // Trying to compare a negative value; eg. ($var || -1 === $b).
        $this->nonOperandTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$booleanOperators;
        // Trying to assign a negative value; eg. ($var = -1).
        $this->nonOperandTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
        ...
        $this->nonOperandTokens += \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$castTokens;
        /*
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr - 1]['code'] !== \T_WHITESPACE && ($tokens[$stackPtr - 1]['code'] === T_INLINE_THEN && $tokens[$stackPtr]['code'] === T_INLINE_ELSE) === \false) {
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$assignmentTokens[$tokens[$stackPtr]['code']]) === \false || $this->ignoreSpacingBeforeAssignments === \false) {
        ...
        if ($tokens[$stackPtr + 1]['code'] !== \T_WHITESPACE) {
            ...
            if ($found !== 1 && ($found !== 'newline' || $this->ignoreNewlines === \false)) {
                ...
                if ($nextNonWhitespace !== \false && isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens[$tokens[$nextNonWhitespace]['code']]) === \true && $found === 'newline') {
     ...
     * @return boolean
     */
    protected function isOperator(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
