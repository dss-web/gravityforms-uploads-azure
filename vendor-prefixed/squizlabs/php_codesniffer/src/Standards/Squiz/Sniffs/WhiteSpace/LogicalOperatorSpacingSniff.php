...
class LogicalOperatorSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        return \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$booleanOperators;
    }
    //end register()
    /**
