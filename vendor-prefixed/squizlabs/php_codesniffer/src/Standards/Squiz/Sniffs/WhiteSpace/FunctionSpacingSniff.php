...
class FunctionSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $previousNonEmpty = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        $isFirst = \false;
        $isLast = \false;
        $ignore = [\T_WHITESPACE => \T_WHITESPACE] + \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$methodPrefixes;
        ...
        if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$next]['code']]) === \true && $tokens[$next]['line'] === $tokens[$closer]['line']) {
        ...
        */
        ...
        if ($prevLineToken === null) {
            ...
            if ($tokens[$prevContent]['code'] === \T_COMMENT || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens[$tokens[$prevContent]['code']]) === \true) {
