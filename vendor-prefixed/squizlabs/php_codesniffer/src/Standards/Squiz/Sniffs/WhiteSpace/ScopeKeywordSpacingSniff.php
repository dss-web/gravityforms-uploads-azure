...
class ScopeKeywordSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $register = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$scopeModifiers;
        $register[] = \T_STATIC;
        return $register;
    }
    //end register()
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $nextToken = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr + 1, null, \true);
        if ($tokens[$stackPtr]['code'] === \T_STATIC) {
            ...
            if ($prevToken !== \false && $tokens[$prevToken]['code'] === T_COLON) {
                $prevPrevToken = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $prevToken - 1, null, \true);
