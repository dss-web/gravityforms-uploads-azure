...
class ObjectOperatorSpacingSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
     ...
     */
    protected function checkSpacingBeforeOperator(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $before)
    {
     ...
     * @return boolean true if there was no error, false otherwise.
     */
    protected function checkSpacingAfterOperator(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $after)
    {
