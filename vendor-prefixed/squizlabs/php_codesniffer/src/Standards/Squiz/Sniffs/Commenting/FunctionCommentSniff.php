 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\Commenting;

use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Commenting\FunctionCommentSniff as PEARFunctionCommentSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common;
class FunctionCommentSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Commenting\FunctionCommentSniff
{
    /**
     ...
     * @return void
     */
    protected function processReturn(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        ...
        if ($return !== null) {
            ...
            if (empty($content) === \true || $tokens[$return + 2]['code'] !== T_DOC_COMMENT_STRING) {
                ...
                foreach ($typeNames as $i => $typeName) {
                    $suggestedName = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::suggestType($typeName);
     ...
     * @return void
     */
    protected function processThrows(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        $tokens = $phpcsFile->getTokens();
        if ($this->skipIfInheritdoc === \true) {
            if ($this->checkInheritdoc($phpcsFile, $stackPtr, $commentStart) === \true) {
     ...
     * @return void
     */
    protected function processParams(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        if ($this->phpVersion === null) {
            $this->phpVersion = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getConfigData('php_version');
            if ($this->phpVersion === null) {
                ...
                if (\strpos($suggestedName, 'array') !== \false || \substr($suggestedName, -2) === '[]') {
                    ...
                    if (\strpos($suggestedName, 'callable') !== \false) {
                        ...
                        if (\strpos($suggestedName, 'callback') !== \false) {
                            ...
                            if (\in_array($suggestedName, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::$allowedTypes, \true) === \false) {
     ...
     * @return void
     */
    protected function checkSpacingAfterParamType(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $param, $maxType, $spacing = 1)
    {
        // Check number of spaces after the type.
     ...
     * @return void
     */
    protected function checkSpacingAfterParamName(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $param, $maxVar, $spacing = 1)
    {
        // Check number of spaces after the var name.
     ...
     */
    protected function checkInheritdoc(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        $tokens = $phpcsFile->getTokens();
