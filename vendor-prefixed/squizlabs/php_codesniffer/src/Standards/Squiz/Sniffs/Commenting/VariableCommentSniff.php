...
class VariableCommentSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractVariableSniff
{
    /**
     ...
     * @return void
     */
    public function processMemberVar(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
