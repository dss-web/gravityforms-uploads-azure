 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\Scope;
...
class StaticThisUsageSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return void
     */
    public function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
     ...
     * @return void
     */
    private function checkThisUsage(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $next, $end)
    {
        $tokens = $phpcsFile->getTokens();
        do {
