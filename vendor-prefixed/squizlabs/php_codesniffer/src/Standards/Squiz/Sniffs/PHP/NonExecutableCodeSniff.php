...
class NonExecutableCodeSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        for ($i = $start + 1; $i < $end; $i++) {
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$i]['code']]) === \true || isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$bracketTokens[$tokens[$i]['code']]) === \true || $tokens[$i]['code'] === T_SEMICOLON) {
                continue;
            }
            ...
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens[$tokens[$i]['code']]) === \true || $tokens[$i]['code'] === \T_FUNCTION || $tokens[$i]['code'] === T_CLOSURE) {
