...
class JSLintUnitTest extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Standards\AbstractSniffUnitTest
{
    /**
    ...
    {
        $jslPath = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config::getExecutablePath('jslint');
        if ($jslPath === null) {
            return \true;
        }
        return \false;
