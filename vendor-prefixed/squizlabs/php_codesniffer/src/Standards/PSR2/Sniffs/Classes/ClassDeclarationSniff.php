...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Classes\ClassDeclarationSniff as PEARClassDeclarationSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class ClassDeclarationSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Classes\ClassDeclarationSniff
{
    /**
     ...
     * @return void
     */
    public function processOpen(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        if ($implements !== \false) {
            $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $openingBrace - 1, $implements, \true);
     ...
     * @return void
     */
    public function processClose(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        if ($tokens[$stackPtr]['code'] !== T_ANON_CLASS) {
            ...
            $ignoreTokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens;
