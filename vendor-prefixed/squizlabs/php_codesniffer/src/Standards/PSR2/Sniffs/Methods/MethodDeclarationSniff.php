...
class MethodDeclarationSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
    ...
    {
        parent::__construct(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens, [\T_FUNCTION]);
    }
    //end __construct()
    /**
    ...
    protected function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        $abstract = 0;
        $final = 0;
        $find = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$methodPrefixes + \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        $prev = $phpcsFile->findPrevious($find, $stackPtr - 1, null, \true);
        $prefix = $stackPtr;
        while (($prefix = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$methodPrefixes, $prefix - 1, $prev)) !== \false) {
