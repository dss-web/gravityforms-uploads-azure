...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\OpeningFunctionBraceBsdAllmanSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\OpeningFunctionBraceKernighanRitchieSniff;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens;
class FunctionDeclarationSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        if ($tokens[$stackPtr]['code'] === T_CLOSURE) {
            $sniff = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\OpeningFunctionBraceKernighanRitchieSniff();
        } else {
            $sniff = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\OpeningFunctionBraceBsdAllmanSniff();
        }
    ...
    public function processMultiLineDeclaration($phpcsFile, $stackPtr, $tokens)
    {
        ...
        if ($tokens[$opener]['line'] !== $tokens[$closeBracket]['line']) {
            ...
            if ($fix === \true) {
                $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $opener - 1, $closeBracket, \true);
