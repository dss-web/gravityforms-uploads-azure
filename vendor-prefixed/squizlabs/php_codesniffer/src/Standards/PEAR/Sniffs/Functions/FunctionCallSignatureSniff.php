 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\Functions;
...
class FunctionCallSignatureSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $tokens = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$functionNameTokens;
        $tokens[] = \T_VARIABLE;
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $openBracket = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr + 1, null, \true);
        ...
        $search = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        ...
        if ($tokens[$next]['code'] === T_SEMICOLON) {
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$closeBracket + 1]['code']]) === \true) {
     ...
     * @return void
     */
    public function processSingleLineCall(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $openBracket, $tokens)
    {
            ...
            if ($fix === \true) {
                ...
                if ($spaceBeforeClose === 0) {
                    ...
                    if ($spaceBeforeClose === 'newline') {
                        ...
                        $prev = $closer - 1;
                        while (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$prev]['code']]) === \true) {
     ...
     * @return void
     */
    public function processMultiLineCall(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $openBracket, $tokens)
    {
        ...
        if ($tokens[$first]['code'] === \T_CONSTANT_ENCAPSED_STRING && $tokens[$first - 1]['code'] === \T_CONSTANT_ENCAPSED_STRING) {
            ...
            $first = $phpcsFile->findFirstOnLine(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $prev, \true);
            if ($first === \false) {
                $first = $prev + 1;
            }
        }
        ...
        //end if
        $i = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $openBracket + 1, null, \true);
        ...
        for ($i; $i < $closeBracket; $i++) {
            ...
            if ($tokens[$i]['line'] !== $lastLine) {
                ...
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$heredocTokens[$tokens[$i]['code']]) === \true) {
                    continue;
                }
                // Ignore multi-line string indentation.
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$i]['code']]) === \true && $tokens[$i]['code'] === $tokens[$i - 1]['code']) {
                    continue;
                }
                // Ignore inline HTML.
            ...
            if ($inArg === \false && $tokens[$i]['code'] === T_COMMA) {
                $next = $phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $i + 1, $closeBracket, \true);
                if ($next === \false) {
                    continue;
                }
