 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\PEAR\Sniffs\NamingConventions;
...
class ValidFunctionNameSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
    ...
    protected function processTokenWithinScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::isCamelCaps($testMethodName, \false, \true, \false) === \false) {
    ...
    protected function processTokenOutsideScope(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::isCamelCaps($camelCapsPart, \false, \true, \false) === \false) {
            $validName = \false;
