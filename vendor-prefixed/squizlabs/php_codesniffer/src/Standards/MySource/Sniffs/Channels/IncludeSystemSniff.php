 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\MySource\Sniffs\Channels;
...
class IncludeSystemSniff extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return string
     */
    protected function getIncludedClassFromToken(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, array $tokens, $stackPtr)
    {
        if (\strtolower($tokens[$stackPtr]['content']) === 'includesystem') {
            ...
            if (\strtolower($tokens[$stackPtr]['content']) === 'includeasset') {
                ...
                if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$includeTokens[$tokens[$stackPtr]['code']]) === \true) {
