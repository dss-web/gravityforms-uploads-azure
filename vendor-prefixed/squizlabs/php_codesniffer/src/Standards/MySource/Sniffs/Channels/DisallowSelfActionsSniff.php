...
class DisallowSelfActionsSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
        ...
        for ($i = $classNameToken + 1; $i < $classEnd; $i++) {
            if ($tokens[$i]['code'] !== \T_DOUBLE_COLON) {
                if ($tokens[$i]['code'] === \T_FUNCTION) {
                    ...
                    $funcScope = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$scopeModifiers, $i - 1);
