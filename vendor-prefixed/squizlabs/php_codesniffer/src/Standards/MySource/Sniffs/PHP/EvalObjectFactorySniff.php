 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\MySource\Sniffs\PHP;
...
class EvalObjectFactorySniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        */
        ...
        for ($i = $openBracket + 1; $i < $closeBracket; $i++) {
            if (isset(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$i]['code']]) === \true) {
