 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Standards\Zend\Sniffs\Files;
...
class ClosingTagSniff implements \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$last]['code'] === \T_CLOSE_TAG) {
            ...
            if ($fix === \true) {
                ...
                $prev = $phpcsFile->findPrevious(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $last - 1, null, \true);
