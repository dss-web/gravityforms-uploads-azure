...
$phpunit7 = \false;
if (\class_exists('Dekode\\GravityForms\\Vendor\\PHPUnit\\Runner\\Version') === \true) {
    $version = \Dekode\GravityForms\Vendor\PHPUnit\Runner\Version::id();
    if ($version[0] === '7') {
        $phpunit7 = \true;
    }
}
...
class PHP_CodeSniffer_AllTests
{
    ...
    public static function suite()
    {
        ...
        $suite = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\TestSuite('PHP CodeSniffer');
        $suite->addTest(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\AllTests::suite());
        $suite->addTest(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Standards\AllSniffs::suite());
        return $suite;
    }
    //end suite()
}
