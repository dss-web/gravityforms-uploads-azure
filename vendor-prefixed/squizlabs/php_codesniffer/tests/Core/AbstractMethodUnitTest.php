...
abstract class AbstractMethodUnitTest extends \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$phpcsFile = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\DummyFile($contents, $ruleset, $config);
