...
class ErrorSuppressionTest extends \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testSuppressError($before, $after, $expectedErrors = 0)
    {
        ...
        $file = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\DummyFile($content, $ruleset, $config);
        $file->process();
