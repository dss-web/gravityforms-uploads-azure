 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\Filters\Filter;

use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Filters\Filter;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset;
use Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase;
class AcceptTest extends \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
     * The Config object.
     *
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$config = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config(["--standard={$standard}", "--ignore=*/somethingelse/*"]);
        self::$ruleset = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset(self::$config);
    }
    ...
    public function testExcludePatterns($inputPaths, $expectedOutput)
    {
        ...
        $filter = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Filters\Filter($fakeDI, '/', self::$config, self::$ruleset);
