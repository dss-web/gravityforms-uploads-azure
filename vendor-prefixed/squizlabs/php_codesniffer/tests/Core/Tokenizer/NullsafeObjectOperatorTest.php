...
class NullsafeObjectOperatorTest extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    public function testTernaryThen($testMarker, $testObjectOperator = \false)
    {
        ...
        if ($testObjectOperator === \true) {
            $next = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $operator + 1, null, \true);
