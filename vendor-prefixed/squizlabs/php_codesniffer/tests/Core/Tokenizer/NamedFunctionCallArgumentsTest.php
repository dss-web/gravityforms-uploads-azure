 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\Tokenizer;
...
class NamedFunctionCallArgumentsTest extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    public function testNamedFunctionCallArguments($testMarker, $parameters)
    {
        ...
        foreach ($parameters as $content) {
            ...
            $colon = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $label + 1, null, \true);
    ...
    public function testMixedPositionalAndNamedArgsWithTernary()
    {
        ...
        // Get the next non-empty token.
        $colon = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $true + 1, null, \true);
    ...
    public function testTernaryWithFunctionCallsInThenElse()
    {
        ...
        // Get the next non-empty token.
        $colon = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $closeParens + 1, null, \true);
        $this->assertSame(T_INLINE_ELSE, $tokens[$colon]['code'], 'Token tokenized as ' . $tokens[$colon]['type'] . ', not T_INLINE_ELSE (code)');
        $this->assertSame('T_INLINE_ELSE', $tokens[$colon]['type'], 'Token tokenized as ' . $tokens[$colon]['type'] . ', not T_INLINE_ELSE (type)');
        /*
         * Else.
    ...
    public function testTernaryWithConstantsInThenElse()
    {
        ...
        // Get the next non-empty token.
        $colon = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $constant + 1, null, \true);
        $this->assertSame(T_INLINE_ELSE, $tokens[$colon]['code'], 'Token tokenized as ' . $tokens[$colon]['type'] . ', not T_INLINE_ELSE (code)');
        $this->assertSame('T_INLINE_ELSE', $tokens[$colon]['type'], 'Token tokenized as ' . $tokens[$colon]['type'] . ', not T_INLINE_ELSE (type)');
    }
    ...
    public function testSwitchStatement()
    {
        ...
        // Get the next non-empty token.
        $colon = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $default + 1, null, \true);
