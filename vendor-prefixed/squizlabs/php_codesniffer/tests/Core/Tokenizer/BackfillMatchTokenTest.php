...
class BackfillMatchTokenTest extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    public function testNotAMatchStructure($testMarker, $testContent = 'match')
    {
        ...
        $next = self::$phpcsFile->findNext(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $token + 1, null, \true);
