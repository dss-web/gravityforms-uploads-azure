...
class StableCommentWhitespaceWinTest extends \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    public function testCommentTokenization($testMarker, $expectedTokens)
    {
        ...
        $comment = $this->getTargetToken($testMarker, \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Tokens::$commentTokens);
