...
class RuleInclusionAbsoluteWindowsTest extends \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
     * The Ruleset object.
     *
    ...
    public function setUp()
    {
        ...
        $config = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config(["--standard={$this->standard}"]);
        $this->ruleset = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset($config);
    }
    //end setUp()
    /**
     * Reset ruleset file.
    ...
    public function testWindowsStylePathRuleInclusion()
    {
        ...
        $this->assertSame('Dekode\\GravityForms\\Vendor\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterCastSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterCast']);
