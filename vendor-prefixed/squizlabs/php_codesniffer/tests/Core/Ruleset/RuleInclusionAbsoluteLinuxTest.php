...
class RuleInclusionAbsoluteLinuxTest extends \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
     * The Ruleset object.
     *
    ...
    public function testLinuxStylePathRuleInclusion()
    {
        ...
        $this->assertSame('Dekode\\GravityForms\\Vendor\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterNotSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterNot']);
