 ...
 */
namespace Dekode\GravityForms\Vendor\PHP_CodeSniffer\Tests\Standards;
...
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\LocalFile;
use Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common;
use Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase;
abstract class AbstractSniffUnitTest extends \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
    ...
    public final function testSniff()
    {
        ...
        $sniffCode = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::getSniffCode(\get_class($this));
        ...
        if (isset($GLOBALS['PHP_CODESNIFFER_CONFIG']) === \true) {
            ...
            $config = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Config();
            $config->cache = \false;
        ...
        if (isset($GLOBALS['PHP_CODESNIFFER_RULESETS'][$standardName]) === \false) {
            $ruleset = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Ruleset($config);
        ...
        $sniffClassName = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Common::cleanSniffClass($sniffClassName);
        ...
        foreach ($testFiles as $testFile) {
            ...
            try {
                ...
                $phpcsFile = new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\LocalFile($testFile, $ruleset, $config);
                $phpcsFile->process();
     ...
     */
    public function generateFailureMessages(\Dekode\GravityForms\Vendor\PHP_CodeSniffer\Files\LocalFile $file)
    {
        ...
        if (\is_array($expectedErrors) === \false) {
            throw new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Exceptions\RuntimeException('getErrorList() must return an array');
        }
        if (\is_array($expectedWarnings) === \false) {
            throw new \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Exceptions\RuntimeException('getWarningList() must return an array');
        }
        /*
