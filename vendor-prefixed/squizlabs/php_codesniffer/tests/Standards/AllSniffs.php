...
use Dekode\GravityForms\Vendor\PHPUnit\TextUI\TestRunner;
use Dekode\GravityForms\Vendor\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \Dekode\GravityForms\Vendor\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \Dekode\GravityForms\Vendor\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
        ...
        foreach ($installedStandards as $standard => $details) {
            ...
            foreach ($di as $file) {
                ...
                $className = \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Autoload::loadFile($file->getPathname());
    ...
    {
        return \Dekode\GravityForms\Vendor\PHP_CodeSniffer\Util\Standards::getInstalledStandardDetails(\true);
    }
