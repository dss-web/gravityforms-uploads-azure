...
if (\class_exists('Dekode\\GravityForms\\Vendor\\PHP_CodeSniffer\\Autoload', \false) === \false) {
    class Autoload
    {
        /**
        ...
        public static function load($class)
        {
            ...
            if (self::$composerAutoloader === null) {
                ...
                if (\strpos(__DIR__, 'phar://') !== 0 && @\file_exists(__DIR__ . '/../../autoload.php') === \true) {
                    ...
                    if (self::$composerAutoloader instanceof \Dekode\GravityForms\Vendor\Composer\Autoload\ClassLoader) {
