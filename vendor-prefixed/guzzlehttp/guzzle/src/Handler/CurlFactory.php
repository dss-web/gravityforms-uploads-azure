...
use Dekode\GravityForms\Vendor\GuzzleHttp\Exception\ConnectException;
...
use Dekode\GravityForms\Vendor\GuzzleHttp\Promise\FulfilledPromise;
use Dekode\GravityForms\Vendor\GuzzleHttp\Promise\PromiseInterface;
use Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\LazyOpenStream;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx) : PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri) : string
    {
        ...
        $redactedUriString = \Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\Utils::streamFor($sink);
