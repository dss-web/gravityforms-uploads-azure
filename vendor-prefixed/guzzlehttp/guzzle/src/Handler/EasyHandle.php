...
use Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\Response;
...
final class EasyHandle
{
    ...
    {
        [$ver, $status, $reason, $headers] = \Dekode\GravityForms\Vendor\GuzzleHttp\Handler\HeaderProcessor::parseHeaders($this->headers);
        ...
        $this->response = new \Dekode\GravityForms\Vendor\GuzzleHttp\Psr7\Response($status, $headers, $this->sink, $ver, $reason);
    }
    /**
     * @param string $name
     *
