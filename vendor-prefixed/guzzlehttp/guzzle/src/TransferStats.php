...
final class TransferStats
{
     ...
     */
    public function __construct(\Dekode\GravityForms\Vendor\Psr\Http\Message\RequestInterface $request, ?\Dekode\GravityForms\Vendor\Psr\Http\Message\ResponseInterface $response = null, ?float $transferTime = null, $handlerErrorData = null, array $handlerStats = [])
    {
     ...
     */
    public function getEffectiveUri() : \Dekode\GravityForms\Vendor\Psr\Http\Message\UriInterface
    {
