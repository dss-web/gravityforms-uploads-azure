 ...
 * @final
 */
class LimitStream implements \Dekode\GravityForms\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\Dekode\GravityForms\Vendor\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
