 ...
 * @final
 */
class FnStream implements \Dekode\GravityForms\Vendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Dekode\GravityForms\Vendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
