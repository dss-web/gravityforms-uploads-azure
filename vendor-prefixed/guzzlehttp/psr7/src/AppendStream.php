 ...
 * @final
 */
class AppendStream implements \Dekode\GravityForms\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Dekode\GravityForms\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
